...
class  HospitalTable(db: SQLiteDatabase){
    ...
    fun create() {
        db.execSQL("CREATE TABLE $TABLE_NAME (${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, $FIELD_NAME TEXT NOT NULL, $FIELD_LOCATION TEXT NOT NULL, $FIELD_ADDRESS TEXT NOT NULL, $FIELD_STATE TEXT, $FIELD_INFECTED INTEGER, $FIELD_RECOVERED INTEGER)")
    }
